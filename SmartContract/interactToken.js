...
const appleAddress = "0x0c340A9a1CAA48300A4D68791Dd8bFA6f8f769be";
const vaultAddress = "0x01496E9E7e2A446151a6dB5e1FC4e3EfF8db4610";
const ownerAddress = "0x36be905b39Fddbf4f4FCbe8a421CA35fAE962843";
const receiverAddress = "0xA0D9896a23501239B7c6DDDA681f1007B0A3283A";
async function interact() {
    
    web3 = await new Web3('http://192.248.170.227:8545/');
    vaultContract = await new web3.eth.Contract(appleAPI, appleAddress);
    await web3.eth.accounts.wallet.add("e3457c43ef86a478de411428f59891be4486a7797e71f007d847358c4b47cbb6")
    // console.log(vaultContract);
    // ownerContract=await new web3.eth.Contract(vaultAPI,vaultAddress);
    // role = await vaultContract.methods.balanceOf(ownerAddress).call();
    role = await vaultContract.methods.approve (vaultAddress, 10000000).send(
        {
            from: ownerAddress,
            gas:3000000
        }
