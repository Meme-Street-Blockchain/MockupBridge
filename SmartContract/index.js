...
async function interact() {
    ...
    vaultContract = await new web3.eth.Contract(vaultAPI, vaultAddress);
    ...
    var value = Web3.utils.toWei("2");
    // role = await vaultContract.methods.withdraw(value,receiverAddress).send({
    //     from:vaultAddress,
    //     gas:30000000
    // });
    // role = await vaultContract.methods.setWithdrawEnable(1).send(
    //         {
    //             from: ownerAddress,
    //             gas:3000000
    //         }
    //     );
    // role = await vaultContract.methods.setMaxWithdrawAmount (100000000000).send(
    //     {
    //         from: ownerAddress,
    //         gas: 3000000
    ...
    //     }
    // );
    console.log("Before:",await web3.eth.getBalance(receiverAddress)); 
   
    role = await vaultContract.methods.withdraw(10000000,receiverAddress).send(
        {
            from: ownerAddress,
            gas: 3000000
    ...
    console.log("After:",await web3.eth.getBalance(receiverAddress)); 
    console.log(role);
    // web3 = await new Web3('http://192.248.170.227:8545/');
    ...
    // role = await vaultContract.methods.transfer(receiverAddress, 123456).send(
    //     {
    //         from: ownerAddress,
    //         gas:3000000
    //     }
